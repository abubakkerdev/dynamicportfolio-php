...
?>
    ...
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            ...
            <a class="breadcrumb-item" href="/cit/admin/facts/index.php">Facts</a>
            <span class="breadcrumb-item active">Add Fact</span>
        </nav>
                ...
                <div class="col-lg-12 mg-t-20 mg-lg-t-0">
                    <div class="card">
                        <div class="card-header pd-20 bg-transparent bd-b bd-gray-200">
                            <h6 class="card-title tx-uppercase tx-12 mg-b-0">Add New Fact</h6>
                        </div>
                        <div class="card-body bd-color-gray-lighter rounded-bottom">
                            <div class="dashbord-content">
                                ...
                                <form action="add_fact.php" method="POST">
                                    ...
                                    <div class="col-lg-6 mt-2">
                                        <div class="input-group">
                                            ...
                                            <input type="number" name="number" value="<?= isset($_SESSION['number']) ? $_SESSION['number'] : ''; unset($_SESSION['number']); ?>" class="form-control">
                                        </div>
                                    ...
                                    <div class="col-lg-6 mt-3 mb-3">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="icon" value="<?= isset($_SESSION['icon']) ? $_SESSION['icon'] : ''; unset($_SESSION['icon']); ?>" class="form-control" placeholder="fab fa-twitter">
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <button class="btn btn-primary" name="addFact" type="submit">Add Fact</button>
                                    </div>
                                </form>
                            </div>
                        </div>
