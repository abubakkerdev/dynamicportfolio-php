...
?>
    ...
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            ...
            <a class="breadcrumb-item" href="/cit/admin/testimonials/index.php">Testimonials</a>
                ...
                <div class="col-lg-12 mg-t-20 mg-lg-t-0">
                    <div class="card">
                        <div class="card-header pd-20 bg-transparent bd-b bd-gray-200">
                            <h6 class="card-title tx-uppercase tx-12 mg-b-0">Add New Testimonial</h6>
                        </div>
                                ...
                                <form action="add_testimonial.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-lg-6 mt-2">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="name" value="<?= isset($_SESSION['name']) ? $_SESSION['name'] : ''; unset($_SESSION['name']); ?>" class="form-control">
                                        </div>
                                    ...
                                    <div class="col-lg-6 mt-3">
                                        <div class="input-group">
                                            <textarea rows="3" name="quotes" class="form-control" placeholder="Client Feedback" style="margin-top: 0px; margin-bottom: 0px; height: 130px;"><?= isset($_SESSION['quotes']) ? $_SESSION['quotes'] : ''; unset($_SESSION['quotes']); ?></textarea>
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <button class="btn btn-primary" name="addTestimonial" type="submit">Add Testimonial</button>
                                    </div>
                                </form>
                            </div>
                        </div>
