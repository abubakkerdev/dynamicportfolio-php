...
?>
    ...
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            ...
            <a class="breadcrumb-item" href="/cit/admin/logo/index.php">Logo</a>
                ...
                <div class="col-lg-12 mg-t-20 mg-lg-t-0">
                    <div class="card">
                        <div class="card-header pd-20 bg-transparent bd-b bd-gray-200">
                            <h6 class="card-name tx-uppercase tx-12 mg-b-0">Add New Logo</h6>
                        </div>
                        <div class="card-body bd-color-gray-lighter rounded-bottom">
                            <div class="dashbord-content">
                                ...
                                <form action="add_logo.php" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-lg-6 mt-2 mb-3">
                                        <div class="form-group mg-b-10-force">
                                            <select name="img_cat" class="form-control select2" data-placeholder="Choose User Role">
                                                ...
                                                <?php 
                                                    $img_cat = isset($_SESSION['img_cat']) ? $_SESSION['img_cat'] : NULL;
                                                ?>
                                    ...
                                    <div class="col-lg-6">
                                        <button class="btn btn-primary" name="addLogo" type="submit">Add Logo</button>
                                    </div>
                                </form>
                            </div>
                        </div>
