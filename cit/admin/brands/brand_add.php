...
?>
    ...
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            ...
            <a class="breadcrumb-item" href="/cit/admin/brands/index.php">Brands</a>
                ...
                <div class="col-lg-12 mg-t-20 mg-lg-t-0">
                    <div class="card">
                        <div class="card-header pd-20 bg-transparent bd-b bd-gray-200">
                            <h6 class="card-name tx-uppercase tx-12 mg-b-0">Add New Brand</h6>
                        </div>
                                ...
                                <form action="add_brand.php" method="POST" enctype="multipart/form-data">
                                    <div class="col-lg-6 mt-3 mb-3">
                                        <label class="custom-file">
                                            <input type="file"  name="brand_img" id="file" class="custom-file-input choosen-imgi form-control-lg">
                                        ...
                                        <?php elseif (isset($_SESSION['brand_img'])) : ?>
                                            <div class="alert alert-warning mt-2" role="alert">
                                                <?= $_SESSION['brand_img']; ?>
                                            </div> 
                                            <?php unset($_SESSION['brand_img']); ?>                   
                                        <?php endif; ?>
                                    </div>
