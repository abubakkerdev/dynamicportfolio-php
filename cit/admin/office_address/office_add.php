...
?>
    ...
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            <a class="breadcrumb-item" href="/cit/admin/dashboard.php">Dashboard</a>
            <a class="breadcrumb-item" href="/cit/admin/office_address/index.php">Offices</a>
            <span class="breadcrumb-item active">Add Offices Address</span>
        </nav>
                ...
                <div class="col-lg-12 mg-t-20 mg-lg-t-0">
                    <div class="card">
                        <div class="card-header pd-20 bg-transparent bd-b bd-gray-200">
                            <h6 class="card-title tx-uppercase tx-12 mg-b-0">Add New Offices Address</h6>
                        </div>
                                ...
                                <form action="add_office.php" method="POST">
                                    <div class="col-lg-9 mt-2">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="office_add" value="<?= isset($_SESSION['office_add']) ? $_SESSION['office_add'] : ''; unset($_SESSION['office_add']); ?>" class="form-control">
                                        </div>
                                    ...
                                    <div class="col-lg-9 mt-3">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="number" value="<?= isset($_SESSION['number']) ? $_SESSION['number'] : ''; unset($_SESSION['number']); ?>" class="form-control">
                                        </div>
                                    ...
                                    <div class="col-lg-9 mt-3">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="office_city" value="<?= isset($_SESSION['office_city']) ? $_SESSION['office_city'] : ''; unset($_SESSION['office_city']); ?>" class="form-control">
                                        </div>
                                    ...
                                    <div class="col-lg-9 mt-3">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="city_add" value="<?= isset($_SESSION['city_add']) ? $_SESSION['city_add'] : ''; unset($_SESSION['city_add']); ?>" class="form-control">
                                        </div>
                                    ...
                                    <div class="col-lg-9 mt-3">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="city_num" value="<?= isset($_SESSION['city_num']) ? $_SESSION['city_num'] : ''; unset($_SESSION['city_num']); ?>" class="form-control">
                                        </div>
                                    ...
                                    <div class="col-lg-9 mt-3 mb-3">
                                        <div class="input-group">
                                            <textarea rows="3" name="info" class="form-control" placeholder="Description" style="margin-top: 0px; margin-bottom: 0px; height: 140px;"><?= isset($_SESSION['info']) ? $_SESSION['info'] : ''; unset($_SESSION['info']); ?></textarea>
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <button class="btn btn-primary" name="addOffice" type="submit">Add Address</button>
                                    </div>
                                </form>
                            </div>
                        </div>
