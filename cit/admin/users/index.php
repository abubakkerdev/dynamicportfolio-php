...
<html lang="en">
  <head>
    ...
    <link href="/cit/admin/backend_assets/lib/select2/css/select2.min.css" rel="stylesheet">
  ...
  <body>
    <div class="d-flex align-items-center justify-content-center bg-sl-primary ht-md-100v">
      <div class="login-wrapper wd-300 wd-xs-400 pd-25 pd-xs-26 bg-white">
        ...
        <div class="mg-t-20 tx-center">Already have an account? <a href="/cit/admin/login/login.php" class="tx-info">Sign In</a></div>
      </div><!-- login-wrapper -->
    </div><!-- d-flex -->
    ...
    <script src="/cit/admin/backend_assets/lib/select2/js/select2.min.js"></script>
