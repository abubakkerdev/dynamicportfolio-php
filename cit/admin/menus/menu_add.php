...
?>
    ...
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            ...
            <a class="breadcrumb-item" href="/cit/admin/menus/index.php">Menus</a>
                ...
                <div class="col-lg-12 mg-t-20 mg-lg-t-0">
                    <div class="card">
                        <div class="card-header pd-20 bg-transparent bd-b bd-gray-200">
                            <h6 class="card-name tx-uppercase tx-12 mg-b-0">Add New Menu</h6>
                        </div>
                        <div class="card-body bd-color-gray-lighter rounded-bottom">
                            <div class="dashbord-content">                            
                                ...
                                <form action="add_menu.php" method="POST">
                                    ...
                                    <div class="col-lg-6">
                                        <button class="btn btn-primary" name="addMenu" type="submit">Add Menu</button>
                                    </div>
                                </form>                                  
                            </div>
                        </div>
