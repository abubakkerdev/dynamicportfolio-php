  ...
  <div class="sl-mainpanel">
          ...
          <div class="card widget-messages mg-t-20">
            ...
            <div class="list-group list-group-flush">
              <a href="" class="list-group-item list-group-item-action media">
                <img src="backend_assets/img/img10.jpg" alt="">
              ...
              <a href="" class="list-group-item list-group-item-action media">
                <img src="backend_assets/img/img9.jpg" alt="">
                <div class="media-body">
                  <div class="msg-top">
              ...
              <a href="" class="list-group-item list-group-item-action media">
                <img src="backend_assets/img/img8.jpg" alt="">
                <div class="media-body">
                  <div class="msg-top">
              ...
              <a href="" class="list-group-item list-group-item-action media">
                <img src="backend_assets/img/img7.jpg" alt="">
                <div class="media-body">
                  <div class="msg-top">
    ...
    <footer class="sl-footer">
      <div class="footer-left">
        <div class="mg-b-2">Copyright &copy; 2017. Web Command Interface. All Rights Reserved.</div>
