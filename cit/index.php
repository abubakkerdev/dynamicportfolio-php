...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="frontend/frontend_assets/img/favicon.png">
                                    ...
                                    <div class="collapse navbar-collapse" id="navbarNav">
                                        <ul class="navbar-nav ml-auto">
                                            <?php foreach ($all_menu_query as $menu_id => $menu_value) : ?>
                                                <li class="nav-item <?= ($menu_id == 0) ? 'active' : NULL ?>">
                        ...
                        <?php foreach ($all_brand_query as $brand_value) : ?>
                            <div class="col-xl-2">
                                <div class="single-brand">
                                    <img src="admin/uploads/brands/<?= $brand_value['brand_img']; ?>" alt="img">
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
